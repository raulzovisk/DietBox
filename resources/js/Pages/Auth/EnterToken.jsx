...
export default function EnterToken({ error }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('register.validate-token'));
    };

    return (
        <>
            <Head title="Código de Convite" />
                    ...
                    <div className="w-full max-w-md space-y-8">
                        ...
                        >
                            ...
                            <div className="mb-6 text-sm text-slate-600 text-center">
                                Para criar uma conta, você precisa de um código de convite. Cole o código que recebeu abaixo.
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="mt-1">
                                        <input
                                            ...
                                            required
                                            autoFocus
                                            className="appearance-none block w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm placeholder-slate-400 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm bg-white text-slate-900 font-mono"
                                        />
                                    </div>
                                    {errors.token && (
